...
/* variables */
    ...
    $fullPartNumber = $_POST['full_part_number'];
    $price = $_POST['price'];
    $light_info = $_POST['light_info'];
                                        ...
                                        <tbody>
                                          <tr>
                                            <td valign="middle" class="textContent">
                                              <img id="logo" src="https://acihoist.com/images/logo.png">
											</td>
											<td  valign="middle" class="textContent">
                                              <h2 style="font-weight:bold;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;line-height:135%;color:#FFF;">Custom Pendant Configurator</h2>

                                              <div style="font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;clear:both;">Thank you for using the custom pendant configurator. We will be in touch shortly!</div>
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
...
<table id="customerInfoTable" align="center" cellpadding="3" cellspacing="0"> 
 ...
 <?foreach($_POST as $key => $val) {	  
		if($key == "pendant_slot_info" || $key == "light_info"){
			continue;
		}?>
			<tr>
				<td valign="top">
	...
	<table id="pendantInfoTable" align="center" cellpadding="3" cellspacing="0"> 
		<tbody>
	<?if($light_info != 'noLight' || $light_info != ''){?>	
		<? $light = explode("|", $light_info)?>
		<tr>
			<td colspan="2">
				<h4 style="font-style:normal; margin: 10px 0 3px 0;">Light</h4>
			</td>
		</tr>
		<tr>
			<td class="slotInfo">
	...
	<?}?>
			...
			<tr>										
				<td style="border-top: #DADADA 1px solid;">
					<h2 style="color:black"><strong>Part Number: </strong><?=$fullPartNumber?></h2>													  
					<h2 style="color:black"><strong>Estimated Price: </strong>$<?=$price?></h2>		
				</td>
			</tr>
                                          </tr>
                                        </tbody>
